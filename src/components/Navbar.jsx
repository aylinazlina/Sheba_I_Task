      ...
      <header className="flex shadow-md py-4 px-4 sm:px-10 bg-white min-h-[70px] tracking-wide relative z-50">
        <div className="flex flex-wrap items-center justify-between gap-5 w-full">
            ...
            <ul className="lg:flex gap-x-4 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
              <li className="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3">
                <a
                  ...
                  className="hover:text-hover_color hover:font-semibold text-primary_color block font-normal text-[20px] font-font_Inter"
                >
                  Home
                </a>
              </li>
          ...
          <div className="flex max-lg:ml-auto space-x-4">
            <Button btnDesign="px-7 py-3 bg-primary_color rounded-lg text-white font-font_Inter text-bold text-[16px] cursor-pointer" btnContent="Log In"/>
