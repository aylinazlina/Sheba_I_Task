...
const Service = () => {
  return (
    <section className="px-4 py-8 sm:px-6 md:px-8 lg:px-12 xl:px-20 bg-transparent mb-6">
      <div className="relative bg-service_color rounded-2xl overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row p-4 sm:p-6 md:p-8 gap-6">
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center">
            <h2 className="text-center lg:text-left font-bold text-2xl sm:text-3xl md:text-4xl lg:text-[62.4px] font-lato text-black leading-tight mb-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center">
              ...
              >
                ...
                <div className="text-left">
                  <p className="text-[10px] sm:text-xs font-medium leading-none">Download on the</p>
              ...
              >
                ...
                <div className="text-left">
                  <p className="text-[10px] sm:text-xs font-medium leading-none">Get it on</p>
          ...
          <div className="w-full lg:w-1/2 flex justify-center lg:justify-end items-center relative">
            ...
            <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl h-[400px] sm:h-[500px]">
              <img
                src={image_1}
                alt="Service 1"
                className="absolute w-[60%] sm:w-[55%] top-[30%] right-[35%] max-w-[250px]"
              />
              <img
                src={image_2}
                alt="Service 2"
                className="absolute w-[60%] sm:w-[55%] top-[50%] right-[5%] max-w-[250px]"
              />
            </div>
          </div>
        </div>
