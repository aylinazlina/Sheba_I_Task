      ...
      <div className="px-2 py-6 bg-gray-100 relative sm:px-6 md:px-12 md:py-12">
        ...
        <div className="mx-2 bg-transparent rounded-r-md relative lg:absolute lg:top-[5%] lg:left-[25%]">
          <div className="flex flex-col flex-wrap justify-center items-center mt-4 md:mt-8">
            <p className="font-lato font-bold text-[28px] leading-[36px] mb-2 md:text-[48px] md:leading-[58px] md:mb-4">
              HOW IT WORKS
            </p>
            <p className="font-main font-normal text-[14px] leading-[22px] w-full text-center md:text-[16px] md:leading-[27px] md:w-[651px]">
        ...
        <div className="bg-transparent px-2 py-4 mx-2 relative lg:absolute lg:top-[18%] lg:left-[7%] lg:px-4 lg:py-8 lg:mx-5">
          <div className="bg-white w-full max-w-[426px] h-auto rounded-xl flex flex-col justify-center items-center mx-auto py-4 md:h-[286px]">
            <div className="w-[50px] h-[50px] bg-gray-200 rounded-full relative md:w-[70px] md:h-[70px]">
              <div className="w-[32px] h-[32px] rounded-full bg-black absolute top-[18%] left-[15%] flex items-center justify-center md:w-[45px] md:h-[45px]">
                <p className="text-white font-font_Inter font-semibold text-[20px] text-center md:text-[32px]">
                  1
                </p>
              </div>
            </div>
            <p className="font-lato font-semibold text-[18px] mt-2 md:text-[24px] md:mt-4">
              LOREM IPSUM
            </p>
            <p className="font-main font-normal text-[14px] leading-[22px] mx-2 w-full text-center md:text-[16px] md:leading-[27px] md:mx-6 md:w-[340px]">
              There are many variations of passages of Lorem Ipsum available,
        ...
        <div className="bg-transparent px-2 py-4 mx-2 relative lg:absolute lg:top-[75%] lg:right-[6%] lg:px-4 lg:py-8 lg:mx-5">
          <div className="bg-white mb-4 w-full max-w-[426px] h-auto rounded-xl flex flex-col justify-center items-center mx-auto py-4 md:h-[286px]">
            <div className="w-[50px] h-[50px] bg-gray-200  rounded-full relative md:w-[70px] md:h-[70px]">
              <div className="w-[32px] h-[32px] rounded-full bg-black absolute top-[18%] left-[15%] flex items-center justify-center md:w-[45px] md:h-[45px]">
                <p className="text-white font-font_Inter font-semibold text-[20px] text-center md:text-[32px]">
                  4
